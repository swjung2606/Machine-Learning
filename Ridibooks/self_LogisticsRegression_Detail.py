...
##### 1. Data preparation
# 3 featurs
h_1, h_2, h_3 = np.random.normal(129, 6, 1500) , np.random.normal(162, 5, 1500) , np.random.normal(190, 5, 1500)
w_1, w_2, w_3 = np.random.normal(38, 4, 1500) , np.random.normal(56, 5, 1500), np.random.normal(73, 5, 1500)
iq_1, iq_2, iq_3 = np.random.normal(70, 6, 1500), np.random.normal(107, 5, 1500), np.random.normal(88, 6, 1500)
...
lr = SoftmaxRegression(eta=0.01, epochs=100)
lr.fit(X,y)
'''
