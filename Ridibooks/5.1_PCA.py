...
# PCA 순서!
# 1. 샘플데이터 매트릭스 X_train 의 Normalization 한 X_train_std 구하기
# 2. X_train_std 의 공분산 매트릭스 cov_mat 구하기
# 3. 위의 cov_mat의 고유값과 각 고유값의 고유백터 매트릭스 eigen_vecs 구하기
# 4. 고윳값 내림차수 정렬 후 고유값이 큰 고유백터 몇개를 추출하여 projection 매트릭스 w 구하기.
# 5. X_train_std 와 w 곱하면 완성!
